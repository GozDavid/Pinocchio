...
void Show_PMT_CPU(const char *label)
{
  if (my_numa.world_comm != MPI_COMM_NULL)
      ...
      else if (rapl::state_cpu.at(my_numa.get_my_world_rank()).count(tag))
	{
	  ...
	  /*
	  my_socket_maxima.clear();
	  my_socket_maxima.shrink_to_fit();
	  my_node_summation.clear();
	  my_node_summation.shrink_to_fit();
	  my_world_socket_maxima.clear();
	  my_world_socket_maxima.shrink_to_fit();
	  my_world_socket_minima.clear();
	  my_world_socket_minima.shrink_to_fit();
	  my_world_socket_average.clear();
	  my_world_socket_average.shrink_to_fit();
	  my_world_socket_std.clear();
	  my_world_socket_std.shrink_to_fit();
	  my_world_node_maxima.clear();
	  my_world_node_maxima.shrink_to_fit();
	  my_world_node_minima.clear();
	  my_world_node_minima.shrink_to_fit();
	  my_world_node_average.clear();
	  my_world_node_average.shrink_to_fit();
	  my_world_node_std.clear();
	  my_world_node_std.shrink_to_fit();
	  my_world_summation.clear();
	  my_world_summation.shrink_to_fit();
	  single_nodes_summations.clear();
	  single_nodes_summations.shrink_to_fit();
	  node_maxima.clear();
	  node_maxima.shrink_to_fit();
	  node_minima.clear();
	  node_minima.shrink_to_fit();
	  node_average.clear();
	  node_average.shrink_to_fit();
	  node_std.clear();
	  node_std.shrink_to_fit();
	  */
  ...
  if (my_numa.world_comm != MPI_COMM_NULL)
      ...
      else
	{
	  ...
	  */
	  ...
	  /*
	  my_node_gpu_summation.clear();
	  my_node_gpu_summation.shrink_to_fit();
	
	  my_node_gpu_maxima.clear();
	  my_node_gpu_maxima.shrink_to_fit();
	  my_node_gpu_minima.clear();
	  my_node_gpu_minima.shrink_to_fit();
	  my_node_gpu_average.clear();
	  my_node_gpu_average.shrink_to_fit();
	  my_node_gpu_std.clear();
	  my_node_gpu_std.shrink_to_fit();
	  my_world_gpu_maxima.clear();
	  my_world_gpu_maxima.shrink_to_fit();
	  my_world_gpu_minima.clear();
	  my_world_gpu_minima.shrink_to_fit();
	  my_world_gpu_average.clear();
	  my_world_gpu_average.shrink_to_fit();
	  my_world_gpu_std.clear();
	  my_world_gpu_std.shrink_to_fit();
	  my_world_gpu_summation.clear();
	  my_world_gpu_summation.shrink_to_fit();
	  single_nodes_summations.clear();
	  single_nodes_summations.shrink_to_fit();
	  node_maxima.clear();
	  node_maxima.shrink_to_fit();
	  ...
	  node_std.clear();
	  node_std.shrink_to_fit();
	  my_node_world_maxima.clear();
	  my_node_world_maxima.shrink_to_fit();
	  my_node_world_minima.clear();
	  my_node_world_minima.shrink_to_fit();
	  my_node_world_average.clear();
	  my_node_world_average.shrink_to_fit();
	  my_node_world_std.clear();
	  my_node_world_std.shrink_to_fit();
	  */
	}
    }
  else
