...
#ifdef GPU_OMP
#include "gpu_cubic_spline_interpolation.h"
#define GPU_BLOCKSIZE 64
#endif // GPU_OMP
...
extern gpu_product_data *gpu_products, *h_gpu_products;
...
#ifdef GPU_OMP
extern double **gpu_second_derivatives;
#endif // GPU_OMP
